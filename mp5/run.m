...
%   Detailed explanation goes here
    ...
    Acc=zeros(3,3);
    Acc(1,1)=sum(corA2)/10;
    Acc(1,2)=sum(corV2)/10;
    Acc(1,3)=sum(corAV2)/10;
    Acc(2,1)=sum(corA5)/10;
    Acc(2,2)=sum(corV5)/10;
    Acc(2,3)=sum(corAV5)/10;
    Acc(3,1)=(sum(corA2)+sum(corA5))/20;
    Acc(3,2)=(sum(corV2)+sum(corV5))/20;
    Acc(3,3)=(sum(corAV2)+sum(corAV5))/20;
    ...
    Acc_v=zeros(3,3);
    Acc_v(1,1)=sum(corA2_v)/10;
    Acc_v(1,2)=sum(corV2_v)/10;
    Acc_v(1,3)=sum(corAV2_v)/10;
    Acc_v(2,1)=sum(corA5_v)/10;
    Acc_v(2,2)=sum(corV5_v)/10;
    Acc_v(2,3)=sum(corAV5_v)/10;
    Acc_v(3,1)=(sum(corA2_v)+sum(corA5_v))/20;
    Acc_v(3,2)=(sum(corV2_v)+sum(corV5_v))/20;
    Acc_v(3,3)=(sum(corAV2_v)+sum(corAV5_v))/20;
    fprintf('\n -------- Accuracy: Viterbi ---------\n ');
    display(array2table(Acc_v,'VariableNames',{'Audio_Recognition','Video_Recognition','AV_Recognition'},'RowNames',{'2','5','Overall'}));
    fprintf('---------------------------------------\n');
end
